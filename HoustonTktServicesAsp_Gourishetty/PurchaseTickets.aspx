            ...
            <houstonTickets:Header id="pgHeader" runat="server"/>
             ...
             <div style="clear: both">
                <div style="text-align: center">
                    <div>
                        <asp:Button ID="btnViewOrder" runat="server" OnClick="btnViewOrder_Click" Text="View Existing Order" CausesValidation="false"/>
                    </div>
                    <div>
                        <span>Select type of Ticket:</span>
                        <span>
                            <asp:RadioButtonList ID="EventType" runat="server" RepeatDirection="Horizontal" TextAlign="Right" align="center">
                                <asp:ListItem Selected="true" Value="events" onClick="dropDownList_Populate();">Houston Event</asp:ListItem>
                                <asp:ListItem Value="sports" onClick="dropDownList_Populate();">Houston Sport</asp:ListItem>
